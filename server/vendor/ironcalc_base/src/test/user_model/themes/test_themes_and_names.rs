...
fn test_named_styles_and_themes() {
    ...
    assert_eq!(resolved_color, "#ECECEC");
    ...
    // Excel's integer HLS tint path resolves #F2994A at tint 0.8 to
    // #FCEADA (verified against Excel's TintAndShade implementation).
    assert_eq!(resolved_color_after_theme, "#FCEADA");
}
