...
def private_path(name: str) -> bool:
    ...
    return (
        ...
        or any(part == "target" or part.startswith("target-") or part == "node_modules" for part in path.parts)
        ...
        or "unippt-gateway" in path.parts
        or "unippt-chatgpt" in path.parts
        or leaf in {"cloud_storage.rs", "collaboration_runtime.rs", "shared_workbooks.rs",
                    "omnidoc_connect.rs", "production_state.rs", "ai_quota.rs",
                    "cloud-storage.js", "collaboration-editor.js", "omnidoc-auth.js",
                    "gateway_guard.rs", "production_runtime.js", "production_runtime.test.js",
                    "unippt_mcp_remote.cjs", "unippt_mcp_remote.test.cjs",
                    "mcp_workspace_worker.cjs", "mcp_workspace_tools.cjs",
                    "mcp_oauth.md", "mcp_oauth_implementation.md",
                    "unippt_omnidoc_r2_integration.md"}
    )
