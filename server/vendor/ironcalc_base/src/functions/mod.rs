    ...
    ($($field:ident => $variant:ident),+ $(,)?) => {
        impl Functions {
            pub fn lookup(&self, name: &str) -> Option<Function> {
                ...
                // GROUPBY and PIVOTBY were added after the bundled, bitcode-encoded
                // language tables were generated.  Their Excel names are invariant,
                // so register them here without changing the binary language format.
                if key == "GROUPBY" {
                    return Some(Function::Groupby);
                }
                if key == "PIVOTBY" {
                    return Some(Function::Pivotby);
                }
                if key == "AGGREGATE" {
                    return Some(Function::Aggregate);
                }
                $(
                    if self.$field == key {
...
impl_function_lookup! {
    ...
    // Compatibility — wrappers
    betadistcompat     => BetaDistCompat,
    hypgeomdistcompat  => HypGeomDistCompat,
    lognormdistcompat  => LogNormDistCompat,
    negbinomdistcompat => NegbinomDistCompat,
    normsdistcompat    => NormSDistCompat,
    tdistcompat        => TDistCompat,
    // Compatibility — aliases (own variant for round-trip serialization)
    chidist            => ChiDistCompat,
    chiinv             => ChiInvCompat,
    chitest            => ChiTestCompat,
    confidence         => ConfidenceCompat,
    covar              => CovarCompat,
    critbinom          => CritbinomCompat,
    loginv             => LoginvCompat,
    betainvcompat      => BetaInvCompat,
    binomdistcompat    => BinomDistCompat,
    expondistcompat    => ExponDistCompat,
    fdistcompat        => FDistCompat,
    finvcompat         => FInvCompat,
    ftestcompat        => FTestCompat,
    gammadistcompat    => GammaDistCompat,
    gammainvcompat     => GammaInvCompat,
    modecompat         => ModeCompat,
    normdistcompat     => NormDistCompat,
    norminvcompat      => NormInvCompat,
    normsinvcompat     => NormSInvCompat,
    percentilecompat   => PercentileCompat,
    percentrankcompat  => PercentrankCompat,
    poissoncompat      => PoissonCompat,
    quartilecompat     => QuartileCompat,
    rankcompat         => RankCompat,
    stdevpcompat       => StDevPCompat,
    tinvcompat         => TInvCompat,
    ttestcompat        => TTestCompat,
    varcompat          => VarCompat,
    varpcompat         => VarPCompat,
    weibullcompat      => WeibullCompat,
    ztestcompat        => ZTestCompat,
...
impl Function {
    pub fn to_localized_name(&self, language: &Language) -> String {
        ...
        match self {
            ...
            Function::Groupby => "GROUPBY".to_string(),
            Function::Pivotby => "PIVOTBY".to_string(),
            ...
            Function::Regexextract => functions.regexextract.clone(),
            Function::Regexreplace => functions.regexreplace.clone(),
            Function::Regextest => functions.regextest.clone(),
            ...
            Function::Char => functions.r#char.clone(),
            ...
            Function::BetaDistCompat => functions.betadistcompat.clone(),
            Function::HypGeomDistCompat => functions.hypgeomdistcompat.clone(),
            Function::LogNormDistCompat => functions.lognormdistcompat.clone(),
            Function::NegbinomDistCompat => functions.negbinomdistcompat.clone(),
            Function::NormSDistCompat => functions.normsdistcompat.clone(),
            Function::TDistCompat => functions.tdistcompat.clone(),
            Function::BetaInvCompat => functions.betainvcompat.clone(),
            Function::BinomDistCompat => functions.binomdistcompat.clone(),
            Function::ChiDistCompat => functions.chidist.clone(),
            Function::ChiInvCompat => functions.chiinv.clone(),
            Function::ChiTestCompat => functions.chitest.clone(),
            Function::ConfidenceCompat => functions.confidence.clone(),
            Function::CovarCompat => functions.covar.clone(),
            Function::CritbinomCompat => functions.critbinom.clone(),
            Function::ExponDistCompat => functions.expondistcompat.clone(),
            Function::FDistCompat => functions.fdistcompat.clone(),
            Function::FInvCompat => functions.finvcompat.clone(),
            Function::FTestCompat => functions.ftestcompat.clone(),
            Function::GammaDistCompat => functions.gammadistcompat.clone(),
            Function::GammaInvCompat => functions.gammainvcompat.clone(),
            Function::LoginvCompat => functions.loginv.clone(),
            Function::ModeCompat => functions.modecompat.clone(),
            Function::NormDistCompat => functions.normdistcompat.clone(),
            Function::NormInvCompat => functions.norminvcompat.clone(),
            Function::NormSInvCompat => functions.normsinvcompat.clone(),
            Function::PercentileCompat => functions.percentilecompat.clone(),
            Function::PercentrankCompat => functions.percentrankcompat.clone(),
            Function::PoissonCompat => functions.poissoncompat.clone(),
            Function::QuartileCompat => functions.quartilecompat.clone(),
            Function::RankCompat => functions.rankcompat.clone(),
            Function::StDevPCompat => functions.stdevpcompat.clone(),
            Function::TInvCompat => functions.tinvcompat.clone(),
            Function::TTestCompat => functions.ttestcompat.clone(),
            Function::VarCompat => functions.varcompat.clone(),
            Function::VarPCompat => functions.varpcompat.clone(),
            Function::WeibullCompat => functions.weibullcompat.clone(),
            Function::ZTestCompat => functions.ztestcompat.clone(),
            ...
            Function::Aggregate => "AGGREGATE".to_string(),
            ...
            Function::ModeSingl => functions.modesngl.clone(),
    ...
    pub fn into_iter() -> IntoIter<Function, 497> {
        [
            ...
            Function::NormSDistCompat,
            Function::TDistCompat,
            Function::BetaInvCompat,
            Function::BinomDistCompat,
            Function::ChiDistCompat,
            Function::ChiInvCompat,
            Function::ChiTestCompat,
            Function::ConfidenceCompat,
            Function::CovarCompat,
            Function::CritbinomCompat,
            Function::ExponDistCompat,
            Function::FDistCompat,
            Function::FInvCompat,
            Function::FTestCompat,
            Function::GammaDistCompat,
            Function::GammaInvCompat,
            Function::LoginvCompat,
            Function::ModeCompat,
            Function::NormDistCompat,
            Function::NormInvCompat,
            Function::NormSInvCompat,
            Function::PercentileCompat,
            Function::PercentrankCompat,
            Function::PoissonCompat,
...
impl Function {
    ...
    pub fn to_xlsx_string(&self) -> String {
        match self {
            ...
            Function::Regexextract => "_xlfn.REGEXEXTRACT".to_string(),
...
impl<'a> Model<'a> {
    pub(crate) fn evaluate_function(
        ...
        match kind {
            ...
            Function::Regexextract => self.fn_regexextract(args, cell),
            Function::Regexreplace => self.fn_regexreplace(args, cell),
            Function::Regextest => self.fn_regextest(args, cell),
            ...
            Function::NormSDistCompat => self.fn_normsdist_compat(args, cell),
            Function::TDistCompat => self.fn_tdist_compat(args, cell),
            Function::BetaInvCompat => self.fn_beta_inv(args, cell),
            Function::BinomDistCompat => self.fn_binom_dist(args, cell),
            Function::ChiDistCompat => self.fn_chisq_dist_rt(args, cell),
            Function::ChiInvCompat => self.fn_chisq_inv_rt(args, cell),
            Function::ChiTestCompat => self.fn_chisq_test(args, cell),
            Function::ConfidenceCompat => self.fn_confidence_norm(args, cell),
            Function::CovarCompat => self.fn_covariance_p(args, cell),
            Function::CritbinomCompat => self.fn_binom_inv(args, cell),
            Function::ExponDistCompat => self.fn_expon_dist(args, cell),
            Function::FDistCompat => self.fn_f_dist_rt(args, cell),
            Function::FInvCompat => self.fn_f_inv_rt(args, cell),
            Function::FTestCompat => self.fn_f_test(args, cell),
            Function::GammaDistCompat => self.fn_gamma_dist(args, cell),
            Function::GammaInvCompat => self.fn_gamma_inv(args, cell),
            Function::LoginvCompat => self.fn_log_norm_inv(args, cell),
            Function::ModeCompat => self.fn_mode_sngl(args, cell),
            Function::NormDistCompat => self.fn_norm_dist(args, cell),
            Function::NormInvCompat => self.fn_norm_inv(args, cell),
            Function::NormSInvCompat => self.fn_norm_s_inv(args, cell),
            Function::PercentileCompat => self.fn_percentile_inc(args, cell),
            Function::PercentrankCompat => self.fn_percentrank_inc(args, cell),
            Function::PoissonCompat => self.fn_poisson_dist(args, cell),
            Function::QuartileCompat => self.fn_quartile_inc(args, cell),
            Function::RankCompat => self.fn_rank_eq(args, cell),
            Function::StDevPCompat => self.fn_stdev_p(args, cell),
            Function::TInvCompat => self.fn_t_inv_2t(args, cell),
            Function::TTestCompat => self.fn_t_test(args, cell),
            Function::VarCompat => self.fn_var_s(args, cell),
            Function::VarPCompat => self.fn_var_p(args, cell),
            Function::WeibullCompat => self.fn_weibull_dist(args, cell),
            Function::ZTestCompat => self.fn_z_test(args, cell),
